...
public class ReviewImageService {
    ...
    public void deleteUnusedReviewImages(String content, List<String> allImageUrls) {
        ...
        uselessReviewImagesUrls.forEach((url) -> imageManager.deleteImage(url, REVIEW_IMAGE));
    ...
    public void deleteOrphanedReviewImages() {
        ...
        uploadedUrls.forEach((uploadedUrl) -> imageManager.deleteImage(uploadedUrl, REVIEW_IMAGE));
    ...
    private String uploadImage(MultipartFile imageFile) throws IOException {
        return imageManager.uploadImage(imageFile.getBytes(), imageFile.getOriginalFilename(), REVIEW_IMAGE);
    }
